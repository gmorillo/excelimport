...
$(function () {
    $( '#datosTramiteTable' ).searchable({
        searchField: '#searchDatosTramite',
        striped: true,
    ...
    $( '#datosEncargoTable' ).searchable({
        searchField: '#searchEncargoTable',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableIdentificadoiresAdmin' ).searchable({
        searchField: '#searchtableIdentificadoiresAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    });
    $( '#tableCompaniesAdmin' ).searchable({
        searchField: '#searchtableCompaniesAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    });
    $( '#tableTechniciansAdmin' ).searchable({
        searchField: '#searchtableTechniciansAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableSolicitudesAdmin' ).searchable({
        searchField: '#searchtableSolicitudesAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableWorksAdmin' ).searchable({
        searchField: '#searchtableWorksAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableIncidentTypesAdmin' ).searchable({
        searchField: '#searchtableIncidentTypesAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableClientesAdmin' ).searchable({
        searchField: '#searchtableClientesAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableMegaworkTypeAdmin' ).searchable({
        searchField: '#searchtableMegaworkTypeAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
    ...
    $( '#tableIngcodeAdmin' ).searchable({
        searchField: '#searchtableIngcodeAdmin',
        striped: true,
        oddRow: { 'background-color': '#f5f5f5' },
        evenRow: { 'background-color': '#fff' },
        searchType: 'fuzzy'
...
$(document).ready(function(){
    $(".getValue").keyup(function(){
          var record = $("#number_record").val();
          var sigor = $("#number_sigor").val();
          var other = $("#number_other").val();
          $("#number_identifier").val(record+'-'+sigor+'-'+other);
    });
    $(".getValue").keyup(function(){
          var record = $("#edit_number_record").val();
          var sigor = $("#edit_number_sigor").val();
          var other = $("#edit_number_other").val();
          $("#edit_number_identifier").val(record+'-'+sigor+'-'+other);
   });
    ...
    $(".amount .delivered").keyup(function(){
          var importeTotal = $(".amount").val();
          var importeEntregado = $(".delivered").val();
          $(".pending").val(importeTotal-importeEntregado);
   });
});

$(document).on("change", ".amount_create", function() {

  var sub = 0;

  $(".amount_create").each(function(){
    sub = (-$(this).val()) - sub;
  });
  $(".pending_payment_create").val(sub);
...
$(function() {                       //run when the DOM is ready
  $(".loaddataspin").click(function() {  //use a class, since your ID gets mangled
    $(".loadingspin").addClass("fa-pulse fa-3x fa-fw");      //add the class to the clicked element
    $(".loadingspin").removeClass("d-none");      //add the class to the clicked element
  });
});
